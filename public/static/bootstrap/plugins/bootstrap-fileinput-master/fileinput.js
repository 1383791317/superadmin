...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tCaption = '<div class="file-caption form-control form-control-sm {class}" tabindex="500">\n' +
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    zoomIcon: '<i class="fas fa-info-circle"></i>',
    ...
    $.fn.fileinput.defaults = {
        ...
        removeClass: 'btn btn-default btn-secondary btn-sm',
        cancelIcon: '<i class="glyphicon glyphicon-ban-circle"></i>',
        cancelClass: 'btn btn-default btn-secondary btn-sm',
        pauseIcon: '<i class="glyphicon glyphicon-pause"></i>',
        pauseClass: 'btn btn-default btn-secondary btn-sm',
        uploadIcon: '<i class="glyphicon glyphicon-upload"></i>',
        uploadClass: 'btn btn-default btn-secondary btn-sm',
        uploadUrl: null,
        uploadUrlThumb: null,
        uploadAsync: true,
        uploadParamNames: {
