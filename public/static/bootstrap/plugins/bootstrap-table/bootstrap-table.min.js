    ...
    function(a) {
        ...
        n.DEFAULTS = {
            ...
            icons: {
                ...
                refresh: "fa-redo-alt text-gray",
                toggle: "fa-toggle-off text-gray",
                columns: "fa-th-list text-gray",
            ...
            n.prototype.initToolbar = function() {
                var b, d, f = this,
                    ...
                    j = 0;
                this.$toolbar.html(""),
                ("string" == typeof this.options.toolbar || "object" == typeof this.options.toolbar) && a(c('<div class="bars float-%s"></div>', this.options.toolbarAlign)).appendTo(this.$toolbar).append(a(this.options.toolbar)),
                    g = [c('<div class="columns columns-%s btn-group float-%s">', this.options.buttonsAlign, this.options.buttonsAlign)],
            ...
            n.prototype.initPagination = function() {
                ...
                this.pageTo > this.options.totalRows && (this.pageTo = this.options.totalRows),
                    m.push('<div class="float-' + this.options.paginationDetailHAlign + ' pagination-detail">', '<span class="pagination-info">', this.options.formatShowingRows(this.pageFrom, this.pageTo, this.options.totalRows), "</span>"),
